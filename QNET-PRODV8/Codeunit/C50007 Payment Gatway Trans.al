...
*/
    ...
    var
        CompanyInfo: Record "Company Information";//11052022
    begin
        CompanyInfo.Get();//11052022 based on requriment skipping for specific company
        if CompanyInfo.Name <> 'QNET MIDDLE EAST GENERAL TRADING LLC' then begin//11052022 based on requriment skipping for specific company
                                                                               repeat
