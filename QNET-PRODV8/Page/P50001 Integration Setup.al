    ...
    layout
    {
        area(content)
        {
            ...
            group("SOMS Sales Order")
            {
                ...
                field("Sale Product GL"; Rec."Sale Product GL")
                {
                    //502000
                    ApplicationArea = All;
                }
                field("VAT Prod. Pos. Grp For Sales"; Rec."VAT Prod. Pos. Grp For Sales")
                {
                    ApplicationArea = All;
                }
                field("Sales Invoice Posting Nos"; Rec."Sales Invoice Posting Nos")
                {
                    ApplicationArea = All;
                }
            }
