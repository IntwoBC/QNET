report 50105 "Delivery- Order"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Report\R50003 Delivery Note.rdl';
        ...
        dataitem("Sales Shipment Header"; "Sales Shipment Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(ATNName; "Sales Shipment Header"."Bill-to Contact")
                    {

                    }
                    column(ATNTel; contact."Mobile Phone No.")
                    {
                    ...
                    column(RequestedDelivery_Date; "Sales Shipment Header"."Requested Delivery Date")
                    {
                    ...
                    dataitem("Sales Shipment Line"; "Sales Shipment Line")
                    {
                        ...
                        column(UOM_SalesShptLineCaption; 'UOM')
                        {
                        }
                        column(No_SalesShptLineCaption; FieldCaption("No."))
                        {
                        }
                        column(HideQtyLine; HideQtyLine[totalLine])
                        {

                        }
                        column(totalLine; totalLine)
                        {
                        ...
                        begin
                            ...
                            IF (type = type::Item) and (Quantity >= 1) Then begin
                                VisiblesLine := true;
                            end;
                            ...
                            totalLine += 1;
                            if VisiblesLine then
                                HideQtyLine[totalLine] := 1;
                            if not VisiblesLine then
                                HideQtyLine[totalLine] := 0;
            ...
            begin
                ...
                CompanyAddr[1] := 'Direct Deals General Trading LLC';
                ...
                CompanyAddr[4] := 'Tax Reg. No.' + ' ' + CompanyInfo."Registration No.";
                ...
                contact.Reset();
                contact.SetRange("No.", "Sales Shipment Header"."Bill-to Contact No.");
                ...
                SalesShipmentLine.SetFilter(AWB, '<>%1', '');
                if SalesShipmentLine.FindFirst() then begin
                    AWB := SalesShipmentLine.AWB;
                    deliveryMethod := SalesShipmentLine."Courier ID";
                end;
    ...
    var
        ...
        deliveryMethod: Code[50];
        AWB: Code[50];
        CompanyInfo: Record "Company Information";
        CompanyInfo1: Record "Company Information";
        Line: Integer;
        VisiblesLine: Boolean;
        ...
        HideQtyLine: array[1000] of Integer;
        totalLine: Integer;
