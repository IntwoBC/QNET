report 50004 "Sales - Order-2"
{
    RDLCLayout = 'Report\R50004 Sales Order.rdl';
    Caption = 'Sales - Order';
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem(Header; "Sales Header")
        {
            ...
            column(No_; "No.") { }
            column(date1; today) { }
            column(SOMS_Order_No_; Header."SOMS Order No.") { }
            ...
            column(Cureencycode; Header."Currency Code") { }
